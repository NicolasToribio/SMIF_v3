...
final_df = pd.DataFrame([price_s, shares_s, total_s])
#print(final_df)


# Making the plotly donut chart
ticker_labels = final_df.columns
stock_values = final_df.iloc[2]
